...
# -------------------------
RAW_IMAGES_DIR = os.getenv('RAW_IMAGES_DIR', 'downloads')
DATASET_DIR = os.getenv('DATASET_DIR', 'datasets')
ORIGINAL_DATASET_DIR = os.getenv('ORIGINAL_DATASET_DIR', 'images')
TEST_DIR = os.getenv('TEST_DIR', 'test-images')
NEW_TEST_DIR = os.getenv('NEW_TEST_DIR', 'new-test-images')
VGG_WEIGHTS_PATH = os.getenv('VGG_WEIGHTS_PATH', 'vgg16_notop/vgg16_weights_tf_dim_ordering_tf_dim_ordering_tf_kernels_notop.h5')
MODEL_PATH = os.getenv('MODEL_PATH', 'Hijab_Detection.h5')
...
if DEBUG:
    print("\n[CONFIG LOADED]")
    for key in [
        'RAW_IMAGES_DIR', 'DATASET_DIR', 'ORIGINAL_DATASET_DIR',
        'TEST_DIR', 'NEW_TEST_DIR', 'VGG_WEIGHTS_PATH',
        'MODEL_PATH', 'TRAIN_DICTIONARY', 'BATH_SIZE',
        'NUMBER_TRAINING_IMAGES', 'NUMBER_VALIDATION_IMAGES', 'TARGET_SIZE',
        'LEARNING_RATE', 'STEP_PER_EPOCH', 'EPOCHS',
